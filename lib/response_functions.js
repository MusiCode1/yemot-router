 ...
 * @property {boolean} allow_typing
 * 
 * @property {string} path
 * @property {string} file_name
 * @property {string} record_ok
 * @property {string} record_hangup
 * @property {string} record_attach
 */
/**
 * @typedef data
...
const Response_Functions = function () {
	...
	const make_record_mode_request = function (data_str, options) {
		...
		let res = [
			...
			(options.record_ok || "yes"),

			(options.record_hangup || "no"),

			(options.record_attach || "no")
		];
